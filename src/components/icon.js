		...
		fetch(`//unpkg.com/@mdi/svg@7.2.96/svg/${this.icon.toLowerCase()}.svg`)
			...
			.then((mdi) => {
				this.root.innerHTML = `
					...
					${mdi.startsWith('<svg') ? mdi : placeholder}
				`
			})
	},
	styles: css`
